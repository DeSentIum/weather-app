...
var API_HEADERS = {
  unitGroup: "metric",
  apiKey: "MRARG8CD49CQKTWQB2G3MSULH",
  apiURL: "https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/",
  contentType: "json"
};
var getWeather = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(url_city_name) {
    var response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.get("".concat(API_HEADERS.apiURL).concat(url_city_name, "?unitGroup=").concat(API_HEADERS.unitGroup, "&key=").concat(API_HEADERS.apiKey, "&contentType=").concat(API_HEADERS.contentType));
        case 3:
...
function connectContent() {
  ...
  var newEle = parent.appendChild(clon);
  return newEle;
}
var printData = /*#__PURE__*/function () {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  searchBtn.addEventListener("click", function (e) {
    ...
    var url_city_name = encodeURI(searchInput.value);
    if (url_city_name) {
      var data = getWeather(url_city_name);
